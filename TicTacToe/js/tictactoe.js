...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            ...
            select.style.backgroundImage = 'url("images/new_X2.jpg")';
            //Active player may not only be "X" or "O" so, if not "X" it must be "O"
        } else {
            //If activePlayer is equal to "0", the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/new_O.jpg")';
        }
...
function checkWinConditions() {
    ...
    // X 6, 7, 8 condition.
    else if (arrayIncludes('6X', '7X', '8X')) {drawWinLine(50, 508, 588, 508) }
    // X 0, 3, 6 condition.
    ...
    // O 6, 7, 8 condition.
    else if (arrayIncludes('6O', '7O', '8O')) {drawWinLine(50, 508, 588, 508) }
    // O 0, 3, 6 condition.
    ...
    //9 squares are selected code executes.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives accesses our HTML canvas element.
